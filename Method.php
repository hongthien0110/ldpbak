...
<head>
    ...
    <link href="css/learn-method.css" rel="stylesheet" type="text/css"/>
...
<!--     <script>
  ...
  <div id="wrapper">
    ...
    <!--slide-->
    <?php require_once './template/learn-method-slide.php' ?>
    <!--text-breath-->
    <?php require_once './template/text-breath.php'; ?>
    <!--content-->
    <?php require_once './template/learn-method-content.php'; ?>
    <!--extra info-->
