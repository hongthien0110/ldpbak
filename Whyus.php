...
<head>
    ...
    <link href="css/whyus.css" rel="stylesheet" type="text/css"/>
    <link href="css/text-breath.css" rel="stylesheet" type="text/css"/>
...
<!--     <script>
  ...
  <div id="wrapper">
    ...
    <!--slide-->
    <?php require_once './template/whyus-slide.php'; ?>

    <!--text-breath-->
    <?php require_once './template/text-breath.php'; ?>
    
    <!--content-->
    <?php require_once './template/whyus-content.php'; ?>
    <!--extra info-->
