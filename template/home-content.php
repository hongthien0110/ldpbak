<div class="container mr-top-80" style="padding: 0;min-width:1170px;">
            ...
            <a href="./Whyus.php">
                ...
                <div class="caption">
                    ...
                    <div class="caption-text text-center">		
                        <p id="home_t2" style="margin-top: 15px;">Practice English online, anywhere, any time without worrying about traffic jam</p>
                    </div>
                </div>
            </a>
        </li>
            ...
            <a href="./Whyus.php">
                ...
                <div class="caption">
                    ...
                    <div class="caption-text">					
                        <p id="home_t3" style="margin-top: 15px;">Pratice English up to 16 hours per day,<br/>as much as you want</p>
                    </div>
                </div>
            </a>
        </li>
        <li style="margin-right:0">
            <a href="./Whyus.php">
                ...
                <div class="caption">
                    <div class="blur"></div>
                    <div class="caption-text">
                        <p  id="home_t4" style="margin-top: 3px;">Each leaner has an individual learning plan, learners can start studying after registration</p>
                    </div>
                </div>
            </a>
        </li>
...
<div class="container">
        <div class="row">
         <img src="img/new_price.png" alt="" style="width: 100%;margin:10px auto; display: block;"/>
        </div>
</div>
<!--MEDIA-->
...
<div class="container student" style="width:1200px;" >
    ...
    <div class="row text-center mr-45 news-logo">
         <div class="col-xs-4">
            <img src="img/n1.png" alt="" class="news-logo-1" />
        </div>
        <div class="col-xs-4">
            <img src="img/n2.png" alt="" class="news-logo-2"/>
        </div>
        <div class="col-xs-4">
            <img src="img/n3.png" alt="" class="news-logo-3"/>
        </div>
    </div>
</div>
